    ...
    <div className="flex min-h-screen flex-col bg-background">
      ...
      <main className="flex-1 overflow-hidden">
        ...
        <section className="w-full pt-28 pb-20 md:pt-36 md:pb-32 lg:pt-35 lg:pb-40 relative">
          ...
          <div
            className="absolute inset-0 bg-gradient-to-tr from-transparent via-primary/10 to-transparent animate-pulse"
            style={{ animationDuration: '4000ms' }}
          ></div>
          
          {/* Floating Elements */}
          <div
            className="absolute top-20 left-10 w-20 h-20 bg-gradient-to-br from-primary/20 to-secondary/20 rounded-full blur-xl animate-bounce"
            style={{ animationDuration: '3000ms' }}
          ></div>
          <div
            className="absolute bottom-20 right-10 w-32 h-32 bg-gradient-to-tl from-secondary/20 to-primary/20 rounded-full blur-xl animate-bounce delay-1000"
            style={{ animationDuration: '4000ms' }}
          ></div>
        ...
        <section className="w-full py-20 md:py-32 relative overflow-hidden">
          ...
          <div
            className="absolute top-10 left-10 w-32 h-32 bg-gradient-to-br from-primary/10 to-secondary/10 rounded-full blur-3xl animate-pulse"
            style={{ animationDuration: '3000ms' }}
          ></div>
          <div
            className="absolute bottom-10 right-10 w-24 h-24 bg-gradient-to-tl from-secondary/10 to-primary/10 rounded-full blur-2xl animate-pulse delay-1000"
            style={{ animationDuration: '4000ms' }}
          ></div>
